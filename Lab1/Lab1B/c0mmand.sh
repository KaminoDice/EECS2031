...
chmod a+r && ls -l myFile

chmod 660 myFile && ls -l myFile

chmod go-w myFile && ls -l myFile

chmod ug+x myFile && ls -l myFile

# Lab 1B-5
mkdir myStuff && ls -ld myStuff

chmod a+r myStuff && ls -ld myStuff

chmod ug+w,o-r myStuff && ls -ld myStuff

chmod a-w,u+w myStuff && ls -ld myStuff

chmod 710 myStuff && ls -ld myStuff
